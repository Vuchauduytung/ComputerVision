...
from EarlyStopping import CustomCallback as CC
...
model = load_model(r"E:\Tung_GIT\My-First-Repository\BreastCancerDetection4\BreastCancerDetection4\Data\breast_cancer_report_final.h5")
